...
int main(){
  ...
  // cout<<"\n";
  // Species res = getSpeciesByName("Frederon");
  // cout<<res.getUniqueSkill().getName();
    // Engimon * e1 = new Engimon("kentang", "Emberon", {Element::Fire}, FlameThrower);

  // Skill s = e1->getUniqueSkill();
  // printVector<Element>(s.getElements(),",",false,false);
  // if(s.getName()==""){
  //   cout<<"SKILLNYA NULL";
  // }
  e1.showDetails();
