...
public class PlayerSprite {
        ...
        public static Animation<TextureRegion> WALKING_SOUTH = new Animation<TextureRegion>(0.25f, WALKING_ANIMATION[0]);
        public static Animation<TextureRegion> WALKING_WEST = new Animation<TextureRegion>(0.25f, WALKING_ANIMATION[1]);
        public static Animation<TextureRegion> WALKING_EAST = new Animation<TextureRegion>(0.25f, WALKING_ANIMATION[2]);
        public static Animation<TextureRegion> WALKING_NORTH = new Animation<TextureRegion>(0.25f, WALKING_ANIMATION[3]);
